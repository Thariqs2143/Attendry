...
import { LayoutDashboard, QrCode, Users, Settings, ScanLine, History, User, Trophy, CalendarOff, BarChart3, type LucideIcon, Crown, Store, Gem, BookLock, Megaphone, Bell, UserCheck } from 'lucide-react';
