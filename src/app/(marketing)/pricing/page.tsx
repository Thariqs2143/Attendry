...
const PricingPage = () => {
 ...
 const plans = [
  ...
  const featureComparison = [
    ...
    { name: 'Export Reports (PDF / Excel)', false, starter: true, growth: true, pro: true },
    { name: 'Muster Roll Generation', false, starter: false, growth: true, pro: true },
    { name: 'Automated Payroll Calculation', false, starter: false, growth: true, pro: true },
    { name: 'Points & Rewards System', false, starter: false, growth: true, pro: true },
    { name: 'Punctuality Leaderboard', false, starter: false, growth: true, pro: true },
    { name: 'Multi-Branch Support', false, starter: false, growth: true, pro: true },
    { name: 'Staff Transfer Between Branches', false, starter: false, growth: true, pro: true },
    { name: 'AI-Powered Weekly Briefing', false, starter: false, growth: false, pro: true },
    { name: 'Smart Staffing Advisor (AI)', false, starter: false, growth: false, pro: true },
    { name: 'Customizable Alerts & Notifications', false, starter: false, growth: false, pro: true },
  ];
