    ...
    <>
      ...
      <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-muted/50 dark:bg-muted/20">
        <div className="container px-4 md:px-6">
          <div class="flex flex-col items-center justify-center space-y-4 text-center">
            <div class="space-y-2">
              <div class="inline-block rounded-full bg-primary/10 border-2 border-primary/20 px-4 py-1.5 text-sm text-primary font-medium">Key Features</div>
              <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl">Everything You Need, Nothing You Don't</h2>
          ...
          <div class="mx-auto grid max-w-5xl items-stretch gap-8 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 lg:max-w-none mt-12">
            <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
              <div class="flex items-center gap-3">
                  <div class="p-3 rounded-full bg-primary/10 text-primary">
                      <QrCode class="h-6 w-6" />
                  </div>
                  <h3 class="text-lg font-bold">QR Code Check-in</h3>
              </div>
             ...
             <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
               <div class="flex items-center gap-3">
                  ...
                  <h3 class="text-lg font-bold">Staff Management</h3>
              </div>
              <p class="text-sm text-muted-foreground">
            ...
            <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
               <div class="flex items-center gap-3">
                  ...
                  <h3 class="text-lg font-bold">Payroll & Muster Reports</h3>
              </div>
              <p class="text-sm text-muted-foreground">
            ...
            <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
               <div class="flex items-center gap-3">
                  ...
                  <h3 class="text-lg font-bold">Leave Management</h3>
              </div>
              <p class="text-sm text-muted-foreground">
             ...
             <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
               <div class="flex items-center gap-3">
                  ...
                  <h3 class="text-lg font-bold">Multi-Branch Support</h3>
              </div>
              <p class="text-sm text-muted-foreground">
            ...
            <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
               <div class="flex items-center gap-3">
                  ...
                  <h3 class="text-lg font-bold">Gamified Rewards</h3>
              </div>
              <p class="text-sm text-muted-foreground">
             ...
             <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
               <div class="flex items-center gap-3">
                  ...
                  <h3 class="text-lg font-bold">AI-Powered Insights</h3>
              </div>
              <p class="text-sm text-muted-foreground">
             ...
             <div class="flex flex-col gap-2 p-6 rounded-lg border-2 bg-background border-border hover:border-primary hover:shadow-lg transition-all">
               <div class="flex items-center gap-3">
                  ...
                  <h3 class="text-lg font-bold">Detailed Analytics</h3>
              </div>
              <p class="text-sm text-muted-foreground">
      ...
      <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32">
        <div class="container px-4 md:px-6">
            <div class="flex flex-col items-center justify-center space-y-4 text-center">
            <div class="space-y-2">
                <div class="inline-block rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary">
                How It Works
                </div>
                <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl">Get Started in 3 Simple Steps</h2>
                <p class="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Our platform is designed for simplicity and speed. Go from signup to tracking in minutes.
                </p>
            </div>
            </div>
            <div class="mx-auto grid max-w-5xl items-start gap-12 md:grid-cols-3 mt-12">
            <div class="grid gap-4 text-center">
                <div class="relative flex justify-center">
                    <div class="p-4 rounded-full bg-primary text-primary-foreground text-2xl font-bold h-16 w-16 flex items-center justify-center">1</div>
                </div>
                <h3 class="text-xl font-bold">Create Your Shop</h3>
                <p class="text-muted-foreground">Sign up as a shop owner and set up your business profile. Invite your employees to join your workspace via email.</p>
            </div>
            <div class="grid gap-4 text-center">
                <div class="relative flex justify-center">
                    <div class="p-4 rounded-full bg-primary text-primary-foreground text-2xl font-bold h-16 w-16 flex items-center justify-center">2</div>
                </div>
                <h3 class="text-xl font-bold">Generate QR Code</h3>
                <p class="text-muted-foreground">Generate a unique QR code for your shop. Choose between a permanent code for printing or a dynamic one for a screen.</p>
            </div>
            <div class="grid gap-4 text-center">
                    <div class="relative flex justify-center">
                    <div class="p-4 rounded-full bg-primary text-primary-foreground text-2xl font-bold h-16 w-16 flex items-center justify-center">3</div>
                </div>
                <h3 class="text-xl font-bold">Scan & Track</h3>
                <p class="text-muted-foreground">Employees scan the QR code with their phone to check in and out. All data is logged in your real-time dashboard instantly.</p>
            </div>
            </div>
        </div>
      </section>
        ...
        <div class="container px-4 md:px-6">
          <div class="flex flex-col items-center justify-center space-y-4 text-center">
            <div class="space-y-2">
              ...
              <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl">Visualize Your Transformation</h2>
              <p class="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div class="mx-auto grid max-w-5xl items-center gap-8 md:grid-cols-2 md:gap-12 mt-12">
            <div class="flex flex-col items-center gap-4 rounded-xl border-2 border-dashed p-8 text-center transition-all hover:border-solid hover:shadow-lg">
                <h3 class="text-xl font-bold text-muted-foreground">Without Attendry</h3>
                 <div class="p-6 bg-muted rounded-full">
                    <Files class="h-10 w-10 text-muted-foreground" />
                </div>
                <p class="text-muted-foreground">Wasting hours on manual attendance registers, payroll errors, and tedious paperwork.</p>
            </div>
             <div class="flex flex-col items-center gap-4 rounded-xl border-2 border-primary/50 bg-primary/5 p-8 text-center transition-all hover:shadow-2xl hover:border-primary">
                <h3 class="text-xl font-bold text-primary">With Attendry</h3>
                <div class="relative">
                  <div class="p-6 bg-primary rounded-full animate-pulse">
                      <QrCode class="h-10 w-10 text-primary-foreground" />
                  </div>
                  <Users class="absolute -top-1 -left-1 h-6 w-6 text-primary animate-pulse delay-300" />
                   <TrendingUp class="absolute -top-1 -right-1 h-6 w-6 text-primary animate-pulse delay-500" />
                   <FileText class="absolute -bottom-1 left-0 h-6 w-6 text-primary animate-pulse delay-700" />
                </div>
                <p class="text-muted-foreground">Automating check-ins with QR codes, simplifying payroll, and empowering employees.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="who-its-for" className="w-full py-12 md:py-24 lg:py-32 bg-muted/50 dark:bg-muted/20">
        <div class="container px-4 md:px-6">
          <div class="flex flex-col items-center justify-center space-y-4 text-center">
            <div class="space-y-2">
              <div class="inline-block rounded-full bg-primary/10 border-2 border-primary/20 px-4 py-1.5 text-sm text-primary font-medium">Who It's For</div>
              <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl">Perfect For Every Local Business</h2>
              <p class="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Whether you run a small shop or a multi-location service, Attendry is designed to fit your unique staffing needs.
              </p>
            </div>
          </div>
          <div class="mx-auto grid max-w-5xl items-stretch gap-8 sm:grid-cols-2 md:grid-cols-3 lg:max-w-none mt-12">
            <Card class="flex flex-col items-center text-center p-8 transition-all duration-300 border-2 border-border hover:border-primary hover:shadow-lg hover:-translate-y-1">
              <div class="p-4 bg-primary/10 rounded-full mb-4">
                <Store class="h-8 w-8 text-primary" />
              </div>
              <h3 class="text-xl font-bold">Retail & Shops</h3>
              <p class="text-muted-foreground mt-2">Manage cashiers, floor staff, and stockists. Easily track shifts and overtime during peak festival seasons.</p>
            </Card>
            <Card class="flex flex-col items-center text-center p-8 transition-all duration-300 border-2 border-border hover:border-primary hover:shadow-lg hover:-translate-y-1">
              <div class="p-4 bg-primary/10 rounded-full mb-4">
                <UtensilsCrossed class="h-8 w-8 text-primary" />
              </div>
              <h3 class="text-xl font-bold">Restaurants & Cafes</h3>
              <p class="text-muted-foreground mt-2">Handle complex schedules for waiters, kitchen staff, and part-time workers. Simplify payroll for tipped employees.</p>
            </Card>
            <Card class="flex flex-col items-center text-center p-8 transition-all duration-300 border-2 border-border hover:border-primary hover:shadow-lg hover:-translate-y-1">
              <div class="p-4 bg-primary/10 rounded-full mb-4">
                <Wrench class="h-8 w-8 text-primary" />
              </div>
              <h3 class="text-xl font-bold">Workshops & Services</h3>
              <p class="text-muted-foreground mt-2">Track hours for mechanics, technicians, and field agents. Ensure accurate time-logging for project-based work.</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32">
          <div class="container px-4 md:px-6">
              <div class="flex flex-col items-center justify-center space-y-4 text-center">
                  <div class="space-y-2">
                      <h2 class="text-3xl font-bold tracking-tighter sm:text-5xl">What Our Customers Say</h2>
                      <p class="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
