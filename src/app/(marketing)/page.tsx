        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-start">
            <div className="flex flex-col justify-center space-y-6">
             ...
             <Image
              src="https://res.cloudinary.com/dnkghymx5/image/upload/v1722850937/Frame_3_1_ku8hvi.png"
              width={700}
              height={700}
              alt="Hero"
      ...
      <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-4 text-center">
                <Image src="https://res.cloudinary.com/dnkghymx5/image/upload/v1722850937/Frame_3_1_ku8hvi.png" alt="Create Shop" width={600} height={400} className="rounded-lg object-cover w-full aspect-[3/2] mb-4"/>
            ...
            <div className="grid gap-4 text-center">
                <Image src="https://res.cloudinary.com/dnkghymx5/image/upload/v1722851082/Frame_4_s1u1vs.png" alt="Generate QR" width={600} height={400} className="rounded-lg object-cover w-full aspect-[3/2] mb-4"/>
            ...
            <div className="grid gap-4 text-center">
                <Image src="https://res.cloudinary.com/dnkghymx5/image/upload/v1722851147/Frame_5_w6p1mt.png" alt="Scan & Track" width={600} height={400} className="rounded-lg object-cover w-full aspect-[3/2] mb-4"/>
