...
const { how_it_works_step_1, how_it_works_step_2, how_it_works_step_3 } = imageData;
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="grid gap-8 md:grid-cols-2 md:gap-12 lg:gap-16 items-center">
                            <Image 
                                ...
                                className="rounded-lg object-cover w-full aspect-video shadow-lg md:order-last"
                            />
                            <div className="space-y-4">
