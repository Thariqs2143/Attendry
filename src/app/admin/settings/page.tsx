  ...
  return (
    <div className="space-y-6">
        <Tabs defaultValue={defaultTab} className="w-full">
            <div className="mb-6">
                <h1 className="text-3xl font-bold tracking-tight hidden md:block">Settings</h1>
                <p className="text-muted-foreground hidden md:block">Manage your account and shop preferences.</p>
            </div>
            
            <div className="sticky top-14 md:top-0 z-30 bg-background/80 backdrop-blur-sm -mx-6 px-6 py-4 mb-6 border-b">
                 <TabsList className="items-center justify-center rounded-md bg-muted p-1 text-muted-foreground grid w-full grid-cols-4 h-auto border-2 border-border">
