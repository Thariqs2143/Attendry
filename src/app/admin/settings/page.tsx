              ...
              <div className="lg:col-span-1">
                ...
                <TabsContent value="business" className="space-y-6 mt-0">
                    ...
                    <Card className="transition-all duration-300 ease-out hover:shadow-lg border-2 border-foreground/20 hover:border-primary">
                        ...
                        <CardContent className="grid sm:grid-cols-3 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input id="lateCat1Deduction" type="number" value={settings.payrollDeductions.lateCategory1Deduction} onChange={(e) => handleDeductionChange('lateCat1Deduction', e.target.value)} placeholder="e.g., 50" />
                            </div>
                             <div className="space-y-2">
                    ...
                    <Card className="transition-all duration-300 ease-out hover:shadow-lg border-2 border-foreground/20 hover:border-primary">
                        ...
                        <CardContent>
                           <Link href="/admin/settings/shifts">
                                <Button>
